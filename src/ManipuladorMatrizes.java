...
public class ManipuladorMatrizes {
	...
	/**
	 * Juntar as matrizes resultados da multiplica��o, uma vez que cada Thread escreve apenas
	 * em uma parte da matriz, aqui ela est� tendo seus resultados unidos.
	 * @param matA
	 *             - Matriz resultado da multiplica��o
	 * @param posicao
	 *             - Range das posi��o que tem os resultados validos
	 * @param linha
